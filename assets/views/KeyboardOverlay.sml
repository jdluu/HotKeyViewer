                ...
                <lane orientation="Vertical" margin="0, 0, 20, 0">
                    ...
                    <lane margin="0,0,0,10">
                        <lane *repeat={:FunctionRow} orientation="Vertical" horizontal-content-alignment="Middle" margin="2">
                             <frame layout={:LayoutSize} background={@Mods/StardewUI/Sprites/ControlBorder} background-tint={:Tint} padding="4" horizontal-content-alignment="Middle" vertical-content-alignment="Middle" focusable="true" left-click=|~KeyboardViewModel.OnKeyClick(^Key)|>
